...
(1, 'Post one', 'Mohamed Hassan', 'Design', 'Competently harness resource-leveling e-tailers with cost effective mindshare. Globally synergize inexpensive quality vectors before inexpensive metrics. Phosfluorescently transition ubiquitous process improvements and process-centric web.', '2023-03-06 13:31:51'),
(2, 'post 2', 'Mohamed Hassan', 'Marketing', 'Competently facilitate visionary web-readiness after progressive process improvements. Globally leverage other\'s high standards in testing procedures without global bandwidth. Progressively underwhelm progressive functionalities rather.', '2023-03-06 13:34:14'),
(3, 'third question ', 'Mohamed Hassan', 'Programming', 'Collaboratively optimize client-based expertise without proactive opportunities. Globally disintermediate high standards in technologies and virtual e-services. ', '2023-03-07 12:53:58'),
(4, 'fourth question', 'Mohamed Hassan', 'Marketing', 'Monotonectally underwhelm prospective communities via intermandated action items. Seamlessly architect strategic meta-services without team driven growth strategies. Quickly network error-free architectures with clicks-and-mortar relationships.', '2023-03-07 13:13:05');
